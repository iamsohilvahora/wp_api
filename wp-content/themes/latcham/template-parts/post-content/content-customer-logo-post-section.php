...
if(have_rows('post_flexible_content', $post_id)):
      while(have_rows('post_flexible_content', $post_id)): the_row();
          if( get_row_layout() == 'customer_logos_section_post' && $_POST['ajaxIndex'] == get_row_index() ):
          $customer_logos_post = get_sub_field('content_post_customer_logos_post');
          $customer_logos_show_title = get_sub_field('content_post_customer_logos_show_title');
          $customer_logos_show_text = get_sub_field('content_post_customer_logos_show_text');
