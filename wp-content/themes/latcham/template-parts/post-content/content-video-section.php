...
if(have_rows('post_flexible_content', $post_id)):
      while(have_rows('post_flexible_content', $post_id)): the_row();
          if( get_row_layout() == 'top_video_post' && $_POST['ajaxIndex'] == get_row_index()):
 ...
 <div class="container">
        ...
        <div class="video-content mp4-video"> 
            ...
            <div class="image-container">
                <div class="bg-cover" style="background-image: url('<?php echo $top_video['top_slider_image']['sizes']['content_solutions']?>');">
