...
if(have_rows('page_flexible_content', $post_id)):
      while(have_rows('page_flexible_content', $post_id)): the_row();
          if( get_row_layout() == 'solution_section_page' && $_POST['ajaxIndex'] == get_row_index() ):
	        $solution = get_sub_field('content_page_solution');
	    	$solution_title = get_sub_field('content_page_solution_title');
