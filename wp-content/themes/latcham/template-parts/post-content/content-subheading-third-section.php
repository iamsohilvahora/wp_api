...
if(have_rows('post_flexible_content', $post_id)):
      while(have_rows('post_flexible_content', $post_id)): the_row();
          if( get_row_layout() == 'sub_heading_third_section_post' && $_POST['ajaxIndex'] == get_row_index()):
          	$imageclone = get_sub_field('content_post_left_image');
            $ImageNull = checkImageNull($imageclone);
            $right_title_third = get_sub_field('content_post_right_title');
            $content = get_sub_field('content_post_content');
            $button = get_sub_field('content_post_button');
