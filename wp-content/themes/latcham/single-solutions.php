...
get_header();
$id = get_the_id();
$terms = get_the_terms($id, 'solutions-category');
$termsIds = array();
if(!empty($terms)){
...
while ( have_posts() ) :
            the_post();
$solutions_post_top_video = get_field('solutions_post_top_video');
if(!empty($solutions_post_top_video['top_slider_image']) || !empty($solutions_post_top_video['top_slider_video']) || !empty($solutions_post_top_video['video_url'])){
    $videocls = "content-with-top-video";
}else{
    $videocls = "content-without-video";
}
$solutions_post_enquire_button = get_field('solutions_post_enquire_button');            
?>
<section class="content-page-top <?php echo $videocls; ?> hero-section section-has-dots">
    <div class="content-page-top-inner">
        <div class="container">
            ...
            <?php if(!empty($solutions_post_enquire_button)){
                                echo button_group($solutions_post_enquire_button,'btn btn-primary');   
                            }
            ?>
        </div>
    </div>

    <?php $ImageNull = checkImageNull($solutions_post_top_video); 
          if($ImageNull){
             if($solutions_post_top_video['select_type'] == 'Image' && $solutions_post_top_video['top_slider_image']['sizes']['content_solutions'] != ""){ ?>
                    <div class="section-content-video">
        <div class="container">
            
            <div class="video-content mp4-video">
                <div class="image-container">
                    <div class="bg-cover" style="background-image: url('<?php echo $solutions_post_top_video['top_slider_image']['sizes']['content_solutions']?>');">
            ...
            <?php }else { 
                    if($solutions_post_top_video['top_slider_video_select'] == 'internal' && $solutions_post_top_video['top_slider_video']['url'] != ""){ ?>
                     <div class="section-content-video">
        <div class="container">
            ...
            <div class="video-content mp4-video">   
                    ...
                    <div class="banner-video-wrap">
                         <div class='player'>
                            <video class="video" width="100%" controls> 
                              <source src="<?php echo $solutions_post_top_video['top_slider_video']['url']; ?>" type="video/mp4">
                            </video>
                 ...
                 <?php }else{ 
                        $video_url = video_url($solutions_post_top_video['video_url']);
                        if(!empty($video_url)){
                    ?>
                    <div class="section-content-video">
        <div class="container">
...
<?php }else if( get_row_layout() == 'case_studies_section_post' ){
 ?>
<section class="section section-image-conetnt section-post-box section-case-study ajaxContent" ajaxIndex="<?php echo get_row_index(); ?>" sectionTemplate="post-content" sectionName="solution-case-study-section"><div class="loader"></div></section>

<?php }else if( get_row_layout() == 'services_section_post' ){ ?>
<section class="section section-utilities services-section hover-dots-effect bg-skyblue ajaxContent" ajaxIndex="<?php echo get_row_index(); ?>" sectionTemplate="post-content" sectionName="solution-service-post-section"><div class="loader"></div></section>
