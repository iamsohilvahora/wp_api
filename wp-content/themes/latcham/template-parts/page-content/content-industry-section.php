...
if(have_rows('page_flexible_content', $post_id)):
      while(have_rows('page_flexible_content', $post_id)): the_row();
          if( get_row_layout() == 'industry_section_page' && $_POST['ajaxIndex'] == get_row_index()):
          	$main_title = get_sub_field('content_page_main_title');
            $industry_button = get_sub_field('content_page_button');
            $industries = get_sub_field('content_page_industries');
