...
if(have_rows('post_flexible_content', $post_id)):
      while(have_rows('post_flexible_content', $post_id)): the_row();
          if( get_row_layout() == 'green_dream_section_post' && $_POST['ajaxIndex'] == get_row_index()):
          	$title = get_sub_field('content_post_title');
            $content = get_sub_field('content_post_content');
            $find_out_button = get_sub_field('content_post_find_out_button');
            ...
            $link = get_sub_field('content_post_link');
            ...
            $right_image = get_sub_field('content_post_right_image');
