...
if(have_rows('post_flexible_content', $post_id)):
      while(have_rows('post_flexible_content', $post_id)): the_row();
          if( get_row_layout() == 'credential_and_logo_section_post'  && $_POST['ajaxIndex'] == get_row_index()):
	        $title = get_sub_field('content_post_title');
            $view_all_button = get_sub_field('content_post_view_all_button');
            $company_logo = get_sub_field('content_post_company_logo');
?>
<div class="container">
    <div class="row">
