...
get_header();
$single_detail_restrict = get_field('single_detail_restrict');
if($single_detail_restrict == "Yes"){
    ?>
    ...
    <div class="content-page-top-inner">
        <div class="container">
            ...
            <div class="row align-items-center">
             ...
             <a <?php echo $top_btnurl; ?> class="btn btn-primary"><?php echo $top_btn_label; ?></a>
                    <?php } ?>
        </div>
    </div>
...
<?php }else if( get_row_layout() == 'sub_heading_third_section' ){ 
        ...
        if($ImageNull){$imgDispaly = ' image--'.$display_section;}else{$imgDispaly = '';}
    ?>
<section class="section section-content section-image-conetnt <?php echo $imgDispaly; ?> ajaxContent" ajaxIndex="<?php echo get_row_index(); ?>" sectionTemplate="content" sectionName="subheading-third-section"><div class="loader"></div></section>
...
<section class="section section-utilities bg-skyblue ajaxContent" ajaxIndex="<?php echo get_row_index(); ?>" sectionTemplate="content" sectionName="services-section"><div class="loader"></div></section>
