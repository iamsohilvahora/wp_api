...
if(have_rows('post_flexible_content', $post_id)):
      while(have_rows('post_flexible_content', $post_id)): the_row();
          if( get_row_layout() == 'case_studies_section_post' && $_POST['ajaxIndex'] == get_row_index()):
                ...
                $case_studies_btn = get_sub_field('content_post_button');
                ...
                $link_label = get_sub_field('content_post_link_label');
                $inquiry_link = get_sub_field('content_post_inquiry_link');
                $internal_link = get_sub_field('content_post_internal_link');
                $external_link = get_sub_field('content_post_external_link');
                if($inquiry_link == 'Internal'){
                    $link =latcham_external_link($internal_link,false);
                }else{
                    $link =latcham_external_link($external_link,true);
                }        
            $case_studies = get_sub_field('content_post_case_studies');
?>          	
